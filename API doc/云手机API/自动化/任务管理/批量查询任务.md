...
- `https://openapi.geelark.cn/open/v1/task/historyRecords`
...
| 参数名       | 必选   |     类型   |    说明    | 示例|
| ----------- | -------| -----------|----------- |----------- |
| size        | 否     |  int | 每页条数，最大值为100 | 100 |
|lastId|否|string|上一页 data.items数组最后一个元素的id值|"574376043897425896"|
| ids | 否 | array[string] | 任务id，最多100个 | ["574376043897425896"] |
