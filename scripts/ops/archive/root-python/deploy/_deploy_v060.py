...
print('=== v0.60 部署: 高级制片全链路体检 P0/P1 修复 ===\n')
...
print('=== 验证版本 ===')
stdin, stdout, stderr = ssh.exec_command('curl -s http://127.0.0.1:3001/api/system/version')
print(stdout.read().decode('utf-8'))

ssh.close()
print(f'\n[OK] v0.60 deployed: api={api_count}, frontend={fe_count}')
