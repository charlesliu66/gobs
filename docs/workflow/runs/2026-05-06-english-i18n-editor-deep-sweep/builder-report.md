...
## 7) Change Summary
- What changed: The scoped editor and ProductionWizard files were localized for English mode, their tests/messages were extended, the changelog was updated to `v0.145`, and the run artifacts now capture the next residue queue.
