...
export default function SettingsPage() {
  ...
  React.useEffect(() => {
    refresh?.registerRefresh("settings", () => load(page))
  }, [refresh, load, page])
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <SectionHeading className="text-lg">代理设置</SectionHeading>
      ...
      <div className="space-y-1 text-sm text-muted-foreground">
        <p>按 GeeLark 文档填写：scheme（socks5/http/https）、server、port；若代理需要认证再填 username / password，不需要则留空。</p>
        <p>列表中的密码通常<strong>不会回显</strong>（安全原因）；需要修改时在「编辑」里重新输入。弹窗里用明文填写便于核对。</p>
      </div>
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              ...
              <Input
                ...
                placeholder="无认证可留空；编辑时若接口未回显需重新填写"
              />
            </div>
          </div>
          <DialogFooter>
