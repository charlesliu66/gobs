# PlannerSpec - 2026-05-11-drive-team-library-import

## 1) Project Goal
- Business goal: Let Google Drive imports write through the Team Library ingest path with the new asset ownership metadata.
...
|---|---|---|---|
| AC-01 | Drive import can download/cache a Drive file and ingest it into the Team Library with the agreed asset metadata shape. | [TODO] | [TODO] |
| AC-02 | The import path reuses the existing asset ingest/preprocess flow instead of inventing a second persistence path. | [TODO] | [TODO] |
| AC-03 | Targeted tests and local frontend/backend builds validate the Drive-to-library happy path and error handling. | [TODO] | [TODO] |
...
- Test evidence: Python unit tests, workflow guard dry-runs, `bash scripts/eval.sh 2026-05-11-drive-team-library-import`.
