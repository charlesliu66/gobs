...
import {
  ...
  extractJsonObject,
  normalizePct3,
  deriveOverviewScoreFromPcts,
  parseKeywordMatrix,
  buildKeywordMatrixFromBatch,
  parseListeningAlerts,
  buildListeningAlertsFromOverview,
  parseRecentTrends,
  normalizeCreators,
  fallbackCreatorsFromVideos,
  STRATEGY_PROFILE_KEYS,
  inferRecommendControlFromConclusion,
  parseStrategyBlockFromRaw,
  parseStrategyVariantFromRaw,
  inferExecutionNature,
  mapTaskRowsToCommentTasks,
  buildFallbackCommentTasksFromVideos,
  cloneCommentTasksForProfile,
  blockFromVariant,
  defaultStrategyProfilesFromBlock,
  enrichStrategyVariant,
  mergeActionsFromStrategy,
  enrichStrategyPlanFields,
  patchCommentTasksLegacy,
  rehydrateSnapshot,
  sanitizeCommentTaskLang,
} from './riskSentimentParsing.js';
...
// 解析/归一化/快照补全函数已提取到 riskSentimentParsing.ts
