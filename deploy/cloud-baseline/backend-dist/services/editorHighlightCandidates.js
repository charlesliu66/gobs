...
export function parseTargetTimelineSec(userMessage) {
...
export function isCombatLikeIntent(userMessage) {
 ...
 */
export function buildUniformCandidateWindows(assetId, durationSec, opts) {
...
export function segmentsToCandidateWindows(assetId, segments) {
...
export function prioritizeCenterWindows(windows, durationSec) {
