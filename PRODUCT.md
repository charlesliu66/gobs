...
**分镜工作台增强功能（v0.42+）：**
- **默认路径瘦身、状态导航与标签收口（v0.122）**：分镜页默认保留生成视频、批量生成缺失视频、状态和预览；首帧生成、AI 审片、快速调整、连续性检查、A/B 对比等收进“高级工具”；分镜列表支持按未开始、等待提交、平台排队中、生成中、已完成、失败、已取消筛选，并提供上一镜 / 下一镜导航；状态筛选与卡片文案统一复用用户态状态 label key。
...
*Last updated: 2026-04-23 (v0.122)*
