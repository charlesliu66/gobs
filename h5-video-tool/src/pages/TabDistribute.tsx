    ...
    <div className="max-w-6xl w-full space-y-6">
      ...
      <PendingDistributionPackages
        ...
        copy={{
          ...
          linkHealth: t('distribute.pendingPackagesLinkHealth'),
          linkHealthy: t('distribute.pendingPackagesLinkHealthy'),
          linkWarning: t('distribute.pendingPackagesLinkWarning'),
          linkBroken: t('distribute.pendingPackagesLinkBroken'),
