        ...
        <div className="grid content-start gap-6">
          <CampaignOutputWorkbench
            ...
            copy={{
              ...
              directReady: t('campaignCreative.outputWorkbench.directReady'),
              templateReady: t('campaignCreative.outputWorkbench.templateReady'),
              ...
              bannerPromptReadiness: t('campaignCreative.outputWorkbench.bannerPromptReadiness'),
              bannerPromptTemplateReady: t('campaignCreative.outputWorkbench.bannerPromptTemplateReady'),
              bannerPromptNeedsAsset: t('campaignCreative.outputWorkbench.bannerPromptNeedsAsset'),
              bannerPromptNeedsCopy: t('campaignCreative.outputWorkbench.bannerPromptNeedsCopy'),
              bannerAssetFitWarnings: t('campaignCreative.outputWorkbench.bannerAssetFitWarnings'),
